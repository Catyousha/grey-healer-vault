      ...
      <div className="flex flex-col">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div className="lg:w-6/12 flex flex-col gap-3 px-4 lg:px-0">
            ...
            <h1 className="text-3xl lg:text-5xl font-bold leading-relaxed font-mono">
            ...
            <p className="text-md text-pretty lg:w-8/12">
              Welcome to my vault of captivating experiences. Explore my work
              and let&apos;s create something benevolent together.
            </p>
          </div>
        </div>
